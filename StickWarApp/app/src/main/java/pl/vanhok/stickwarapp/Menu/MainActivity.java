package pl.vanhok.stickwarapp.Menu;
...
import pl.vanhok.stickwarapp.Game.GameMainActivity;
import pl.vanhok.stickwarapp.IpAddressCode.CodeCreator;
import pl.vanhok.stickwarapp.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String informationIp = "Server is running.\nCode: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HOST = CodeCreator.convertToIpAddress(ed.getText().toString());
                if(r1.isChecked())
    ...
    void serverOperation(){
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                tv.setText(informationIp + CodeCreator.convertToString(server.getIpAddress()));
            }
        });
        server.accept();
        runOnUiThread(new Runnable() {
